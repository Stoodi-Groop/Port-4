...
df_hr <- df %>% 
  pivot_longer(cols = starts_with("HR") & ends_with("led"), names_to = "participant", values_to = "HR_self") 

df_resp <- df %>% 
  pivot_longer(cols = starts_with("Re") & ends_with("led"), names_to = "participant", values_to = "Resp_self") 

df_hr_change <- df %>% 
  pivot_longer(cols = starts_with("HR") & ends_with("change"), names_to = "participant", values_to = "HR_change_self")

df_hr_lag <- df %>% 
  pivot_longer(cols = starts_with("HR") & ends_with("lag"), names_to = "participant", values_to = "HR_lag_self")

df_resp_change<- df %>% 
  pivot_longer(cols = starts_with("Re") & ends_with("change"), names_to = "participant", values_to = "Resp_change_self")

df_resp_lag<- df %>% 
  pivot_longer(cols = starts_with("Re") & ends_with("lag"), names_to = "participant", values_to = "Resp_lag_self")

df_long <- merge(df, df_resp, df_hr, df_hr_change, df_resp_change, df_hr_lag, df_resp_lag, by = ) 
